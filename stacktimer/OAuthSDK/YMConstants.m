...
NSString * const YAMMER_AUTH_REDIRECT_URI = @"stacktimer://oauth.redirect.yammer";

// Put your Yammer App's Client ID here
NSString * const YAMMER_APP_CLIENT_ID = @"DuRX4plucrMTloeE38i0w";
...
NSString * const YAMMER_APP_CLIENT_SECRET = @"MZhmsvYdgzbaQJCarYRp3KHHYeszLqnOUTlIRk5tU";
